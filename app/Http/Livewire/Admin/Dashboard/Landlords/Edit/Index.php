...
namespace App\Http\Livewire\Admin\Dashboard\Landlords\Edit;
...
class Index extends Component
{
    ...
    public function mount($slug)
    {
        ...
        if ($this->user) {
            ...
            session()->flash('error', 'Landlord does not exist');
    ...
    {
        return view('livewire.admin.dashboard.landlords.edit.index')
